...
.menu {
  ...
  box-shadow: 0 2px 5px rgba(109, 177, 255, 0.26);
...
.btn-nav:hover .text-nav,
.btn-nav:active .text-nav,
.btn-nav.router-link-active .text-nav {
  color: #fff;
  font-size: 1.05vw;
}
.btn-nav {
